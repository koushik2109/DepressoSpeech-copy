        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              />
              {errors.adminId && (
                <p className="text-xs text-red-400 mt-1">{errors.adminId}</p>
              )}
            </div>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-white/[0.03] border border-white/[0.06]">
              <svg
                className="w-4 h-4 text-cyan-400/60 flex-shrink-0 mt-0.5"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={1.5}
              ...
              <p className="text-xs text-[#64748B] leading-relaxed">
                Credentials are configured in the backend{" "}
                <code className="px-1 py-0.5 bg-white/5 rounded text-cyan-400/80 text-[10px]">
                  .env
                </code>{" "}
                file. Contact your system administrator if you need access.
              </p>
            </div>
